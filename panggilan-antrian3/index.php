F<!-- Aplikasi Antrian Berbasis Web 
**********************************************
  ...
  <footer class="footer mt-auto py-4">
    <div class="container">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2022 - IT Tampan</a>. All rights reserved.
      </div>
    </div>
  </footer>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian"] + ", menuju, loket, 24 Jam", "Indonesian Male", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
