  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        ...
        <div>
          Selamat Datang di <strong>Aplikasi Antrian Online Berbasis Web</strong>. Silahkan pilih halaman yang ingin ditampilkan.
        </div>
      </div>
        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <a href="panggilan-antrian1" class="btn btn-success rounded-pill px-4 py-2">
                Loket 1 <i class="bi-chevron-right ms-2"></i>
                 <a href="panggilan-antrian2" class="btn btn-success rounded-pill px-4 py-2">
                Loket 2 <i class="bi-chevron-right ms-2"></i>
                <a href="panggilan-antrian3" class="btn btn-success rounded-pill px-4 py-2">
                Loket 24 Jam <i class="bi-chevron-right ms-2"></i>
              </a>
            </div>
          </div>
        </div>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container-fluid">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2022 - IT Tampan. All rights reserved.
      </div>
    </div>
  </footer>
